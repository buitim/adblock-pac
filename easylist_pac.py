...
class EasyListPAC:
    ...
    def easylists_download_latest(self):
        ...
        adguard_url = 'https://filters.adtidy.org/extension/chromium/filters/2.txt'
        ...
        self.download_list = [osidList_url, easylist_url, antiAdBlockFilters, idwya_url, adguard_url, adguard_mobile_url] + self.extra_easylist_urls
